...
const translations = {
  pt: {
    ...
    navCredentials: "cat certificados.md",
  ...
  "sobre": {
    ...
    credentialsTitle: "Certificações e sinais de formação contínua.",
    credential1Title: "Data Science Orientation",
    credential1Text: "Certificação Coursera autorizada pela IBM, com fundamentos de Data Science, IA e Machine Learning aplicados a negócios e pesquisa.",
    ...
    credential2Text: "Portfólio com projetos em saúde, previsão operacional, visão computacional médica e comunicação de impacto para decisão.",
  ...
  en: {
    ...
    navCredentials: "cat credentials.md",
  ...
  "about": {
    ...
    credentialsTitle: "Credentials and continuous learning signals.",
    credential1Title: "Data Science Orientation",
    credential1Text: "Coursera credential authorized by IBM, covering Data Science, AI, and Machine Learning foundations for business and research.",
    ...
    credential2Text: "Portfolio focus across healthcare projects, operational forecasting, medical computer vision, and decision-oriented communication.",
